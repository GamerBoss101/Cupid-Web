<script lang="ts">
    ...
    let CustomSignature = $state(data.pageData.signature);
    let CustomName = $state(data.pageData.name);
    ...
    let backgroundColor = $state(data.pageData.colors.backgroundColor),
        ...
        signatureTextColor = $state(data.pageData.colors.signatureTextColor);
        ...
        >
            {#if pageData != null}
                <h2 class="mx-auto text-2xl">
                    ...
                    <br />
                    <span class="text-sm">
                        (Please note this down for future reference if you want
                        to edit the page)
                    </span>
                </h2>
                <br />
            ...
            {:else}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <label class="label mx-auto">
                        ...
                        <select class="select" onchange={onColorTitleChange}>

<script lang="ts">
    ...
    let FollowUpMessage = $state("Yippe!"),
        followUpImage = $state(
            "https://media1.tenor.com/m/jvsVBSMabc4AAAAC/rose-cat-give-give-rose-to-cat.gif",
        );
    ...
    <div class="mx-auto container space-y-15 px-4 py-20">
        ...
        {#if !Boolean(data.preview)}
            <section class="m-font font-semibold mx-auto">
                <div
                    class="card preset-filled-surface-100-900 p-6 text-center mx-auto grid grid-flow-row w-3/4"
                >
                    {#if pageData != null}
                    ...
                    {:else}
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <button
                                ...
                                onclick={createBMVPage}>Save</button
                            >
                        </div>
                    {/if}
                </div>

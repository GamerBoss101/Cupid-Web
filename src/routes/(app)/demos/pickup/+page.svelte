<script lang="ts">
    ...
    let PickupLine = $state("Do you have a map?");
    let FollowUpLine = $state("Cause I just keep getting lost in your eyes.");

    let ButtonsOptions: any = $state([
        {
            text: "Yes",
            value: "1",
        },
    ...
    let backgroundColor = $state("bg-pink-300"),
        ...
        buttonBGColor = $state("preset-filled-primary-500");
    ...
    <div class="mx-auto container space-y-15 px-4 py-20">
        ...
        {#if !Boolean(data.preview)}
            <section class="mx-auto">
                <div
                    class="mfont card preset-filled-surface-100-900 p-6 text-center mx-auto grid grid-flow-row w-3/4"
                >
                    {#if pageData != null}
                    ...
                    {:else}
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                >
                                <div
                                    class="gap-4 grid grid-cols-1 lg:grid-cols-4"
                                >
                                    {#each ButtonsOptions as option}
